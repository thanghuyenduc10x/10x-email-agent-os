  ...
  <footer class="x10f">\
    ...
    <div class="x10f__main">\
      ...
      <div class="x10f__col">\
        ...
        <ul>' +
          li('https://10x-lifeos.com/', IC_home, L('Trang chủ', 'Home')) +
          li('https://10x-lifeos.com/#community', IC_community, L('Cộng đồng 10X', '10X Community')) +
          li('https://10x-lifeos.com/#tiers', IC_route, L('Lộ trình', 'Programs')) +
          li('https://10x-lifeos.com/blog/', IC_blog, L('Blog · Case thực chiến', 'Blog · Case studies')) +
          li('https://10x-lifeos.com/coach-thang/', IC_coach, L('Về Coach Thắng', 'About Coach Thắng')) +
        '</ul>\
      </div>\
      <div class="x10f__col">\
        <h4>' + L('Sản phẩm & Tài nguyên', 'Products & Resources') + '</h4>\
        <ul>' +
          li('https://10x-lifeos.com/chep-loi/', IC_mic, L('Chép Lời — chép âm thanh', 'Chép Lời — audio to text')) +
          li('https://10x-lifeos.com/fc-fastcapture/', IC_capture, L('FC-FastCapture — ảnh &amp; GIF', 'FC-FastCapture — screenshots &amp; GIF')) +
          li('https://10x-lifeos.com/voiceflow/', IC_wave, L('VoiceFlow — nói thành chữ', 'VoiceFlow — voice to text')) +
          li('https://10x-lifeos.com/vibe-code-os/', IC_route, L('La Bàn Vibe-Code — xây app cùng AI', 'Vibe-Code Compass — build apps with AI')) +
          li('https://10x-lifeos.com/Khampha-Diemthanghoa/', IC_ai, L('La Bàn 30 Ngày — Cố vấn Sự nghiệp', 'La Bàn 30 Ngày — Career compass')) +
          li('https://10x-lifeos.com/app-10xtyping/', IC_wave, L('10xTyping — Nói, để chữ tự viết', '10xTyping — Voice typing')) +
          li('https://10x-lifeos.com/app-Markpicture/', IC_capture, L('MarkPicture — Camera bằng chứng', 'MarkPicture — Evidence camera')) +
          '<li style="opacity:.4"><span class="x10f__ico">' + IC_ai + '</span>' + L('Sắp ra mắt…', 'Coming soon…') + '</li>' +
          li('https://10x-lifeos.com/#resources', IC_ai, L('Hệ thống AI 7 ngày', '7-Day AI System')) +
